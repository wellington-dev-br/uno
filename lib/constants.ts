...
export const ACHIEVEMENTS = {
  ...
  ONE_CARD_WIN: {
    ...
    icon: '🎯',
    criteria: { type: 'game_result', condition: 'one_card_left' },
    points: 50,
  },
  THREE_WILD_DRAW4: {
    id: 'three_wild_draw4',
    ...
    icon: '💣',
    criteria: { type: 'game_result', condition: 'wild_draw4_count', value: 3 },
    points: 75,
  },
  RANKED_WIN: {
    id: 'ranked_win',
    ...
    icon: '⚔️',
    criteria: { type: 'game_result', condition: 'ranked_win' },
    points: 30,
  },
  TOP_50: {
    id: 'top_50',
    ...
    icon: '🥇',
    criteria: { type: 'rank_position', value: 50 },
    points: 200,
  },
  INVITE_10_FRIENDS: {
    ...
    icon: '🦋',
    criteria: { type: 'friends_invited', value: 10 },
    points: 100,
  },
  TEN_PLAYER_GAME: {
    id: 'ten_player_game',
    ...
    icon: '🎉',
    criteria: { type: 'game_result', condition: 'player_count', value: 10 },
    points: 150,
  },
  QUICK_WIN: {
    id: 'quick_win',
    ...
    icon: '⚡',
    criteria: { type: 'game_result', condition: 'duration_minutes', value: 5 },
    points: 40,
  },
  NO_DRAW_WIN: {
    id: 'no_draw_win',
    name: 'Pure Skill',
    description: 'Win a game without drawing a card',
    icon: '🧠',
    criteria: { type: 'game_result', condition: 'no_draws' },
    points: 80,
  },
  ACTION_MASTER: {
    id: 'action_master',
    name: 'Combo King',
    description: 'Play 5 action cards in one game',
    icon: '🛠️',
    criteria: { type: 'game_result', condition: 'action_cards_played', value: 5 },
    points: 80,
  },
  MARATHONER: {
    id: 'marathoner',
    ...
    icon: '🏃‍♂️',
    criteria: { type: 'games_completed', value: 50 },
    points: 120,
  },
  SOCIAL_GAMER: {
    id: 'social_gamer',
    name: 'Social Gamer',
    description: 'Play 20 games with friends',
    icon: '🤝',
    criteria: { type: 'games_with_friends', value: 20 },
    points: 90,
  },
  NIGHT_OWL: {
    id: 'night_owl',
    ...
    icon: '🌙',
    criteria: { type: 'time_played', condition: 'after_22' },
    points: 35,
  },
  COMEBACK: {
    id: 'comeback',
    ...
    icon: '♻️',
    criteria: { type: 'game_result', condition: 'come_back' },
    points: 70,
  },
  COLLECTOR: {
    id: 'collector',
